            ...
            <div class="row">
                ...
                <div class="record-details column col-12 col-md-5">
                    ...
                    <div class="form-group">
                        ...
                        <select id="service-availabilities-type" class="form-control" readonly>
<!-- CUSTOM: Removed option to select "Flexible" type otherwise the periods give too many options in 15 minute chunks
                            <option value="<?= AVAILABILITIES_TYPE_FLEXIBLE ?>">
                                <?= lang('flexible') ?>
                            </option> -->
                            <option value="<?= AVAILABILITIES_TYPE_FIXED ?>" selected>
                                <?= lang('fixed') ?>
                            </option>
                        </select>
                    </div>
...
<!-- CUSTOM: Removed option to select Multiple attendants as I did not modify the code to make the available hours work with this option -->
                        <input id="service-attendants-number" class="form-control required" type="number" min="1" max="1" value="1" readonly>
                    </div>
